...
╚═╝ ╚═════╝ ╚═════╝ 
                          ...
                          [bold white]𝕄𝕒𝕕𝕖 𝔹𝕪 [bold red]LUTHFI XD [bold blue]ℂ𝕠𝕕𝕖𝕣""",width=100,padding=(0,8),title=f"[bold white]LuthfiXD",style=f"bold green"))        
...
luci.append(panel(f"""[bold white][[bold green]01[bold white]] 4 Day 40K\n[bold white][[bold green]02[bold white]] 6 Day 60K\n[bold white][[bold green]03[bold white]] 7 Day 100K [DISKON]""",width=50,padding=(0,8),style=f"bold green"))
...
if luciverganteng_banget in ['1']:
	os.system("xdg-open https://wa.me/+6283861251898?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+4+Day+40K")
elif luciverganteng_banget in ['2']:
	os.system("xdg-open https://wa.me/+6283861251898?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+6+Day+60K")
elif luciverganteng_banget in ['3']:
	os.system("xdg-open https://wa.me/+6283861251898?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+7+Day+100K+yang+diskon")
elif luciverganteng_banget in ['4']:
	os.system("xdg-open https://wa.me/+6283861251898?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+1+Bulan+130K")
elif luciverganteng_banget in ['5']:
	os.system("xdg-open https://wa.me/+6283861251898?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+open+source+100K")
